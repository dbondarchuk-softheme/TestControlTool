...
. .\Logging.ps1 $($sharedFolderPath + "Hyper-V_Machine_Configuration")
...
$NIC = Get-WMIObject Win32_NetworkAdapterConfiguration -computername . | where {$_.Description.Contains("vmxnet") -and $_.IPEnabled}
